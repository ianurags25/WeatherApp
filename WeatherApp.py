...
def getWeather():
    ...
    # weather
    api = "https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=2ceb628b1545313d4519164c95572d5d"
...
#searchbox
search_image=PhotoImage(file="Rounded Rectangle 3-1.png")
myimage=Label(image=search_image,bg="#57adff")
myimage.place(x=270,y=120)

weat_image=PhotoImage(file="Layer 7-1.png")
weatherimage=Label(root,image=weat_image,bg="#203243")
weatherimage.place(x=290,y=125)
...
secondbox=PhotoImage(file="Rounded Rectangle 2 copy-1.png")
...
day1temp=Label(firstframe,bg="#282829",fg="#fff")
...
day2=Label(secondframe,font="arial 9",bg="#282829",fg="#fff")
day2.place(x=10,y=6)
...
day3=Label(thirdframe,font="arial 9",bg="#282829",fg="#fff")
day3.place(x=10,y=6)
...
day4=Label(fourthframe,font="arial 9",bg="#282829",fg="#fff")
day4.place(x=10,y=6)
...
day5=Label(fifthframe,font="arial 9",bg="#282829",fg="#fff")
day5.place(x=10,y=6)
...
day6=Label(sixthframe,font="arial 9",bg="#282829",fg="#fff")
day6.place(x=10,y=6)
...
day6temp.place(x=6,y=75)

#seventh cell

seventhframe=Frame(root,width=70,height=115,bg="#282829")
seventhframe.place(x=605,y=325)

day7=Label(seventhframe,font="arial 9",bg="#282829",fg="#fff")
day7.place(x=10,y=6)
